...
manual_annotations <- read.csv('~/Dropbox/writing/Aedes neurotranscriptome paper/CURRENT DRAFT/Supplemental data/Additional File 3 - AaegLRU gene description DONE/Additional file 3 - AaegLRU annotation.csv')
